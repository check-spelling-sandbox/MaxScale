...
/**
 * Get all warnings generated by the latest command
 *
 * This returns the warning from the previous command and then clears them out.
 *
 * @return The human-readable warnings that were generated
 */
